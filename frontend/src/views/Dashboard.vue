...
import { CircleCheck, Warning, Lock, WarningFilled, Bell } from '@element-plus/icons-vue'
...
const statCards = ref([
  { label: '正常运行', value: 0, icon: 'CircleCheck', color: '#52c41a' },
  { label: '预警监控', value: 0, icon: 'Warning', color: '#faad14' },
  { label: '严重延期', value: 0, icon: 'Warning', color: '#ff4d4f' },
  { label: '锁定保护', value: 0, icon: 'Lock', color: '#722ed1' },
])
